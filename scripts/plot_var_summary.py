...
# richness taxon
ax_rank_vs_richness_taxon = plt.subplot2grid((3, 4), (0, 0))
ax_richness_taxon = plt.subplot2grid((3, 4), (1, 0))
ax_richness_cov_taxon = plt.subplot2grid((3, 4), (2, 0))

# richness phylo
ax_rank_vs_richness_phylo = plt.subplot2grid((3, 4), (0, 1))
ax_richness_phylo = plt.subplot2grid((3, 4), (1, 1))
ax_richness_cov_phylo = plt.subplot2grid((3, 4), (2, 1))

# diversity taxon
ax_rank_vs_diversity_taxon = plt.subplot2grid((3, 4), (0, 2))
ax_diversity_taxon = plt.subplot2grid((3, 4), (1, 2))
ax_diversity_cov_taxon = plt.subplot2grid((3, 4), (2, 2))

# diversity phylo
ax_rank_vs_diversity_phylo = plt.subplot2grid((3, 4), (0, 3))
ax_diversity_phylo = plt.subplot2grid((3, 4), (1, 3))
ax_diversity_cov_phylo = plt.subplot2grid((3, 4), (2, 3))
...
ax_richness_cov_taxon.text(-0.1, 1.04, plot_utils.sub_plot_labels[8], fontsize=10, fontweight='bold', ha='center', va='center', transform=ax_richness_cov_taxon.transAxes)
ax_richness_cov_phylo.text(-0.1, 1.04, plot_utils.sub_plot_labels[9], fontsize=10, fontweight='bold', ha='center', va='center', transform=ax_richness_cov_phylo.transAxes)
ax_diversity_cov_taxon.text(-0.1, 1.04, plot_utils.sub_plot_labels[10], fontsize=10, fontweight='bold', ha='center', va='center', transform=ax_diversity_cov_taxon.transAxes)
ax_diversity_cov_phylo.text(-0.1, 1.04, plot_utils.sub_plot_labels[11], fontsize=10, fontweight='bold', ha='center', va='center', transform=ax_diversity_cov_phylo.transAxes)
...
for environment_idx, environment in enumerate(diversity_utils.environments_to_keep):
    ...
    for rank_idx, rank in enumerate(diversity_utils.taxa_ranks):
        ...
        if rank in taxon_dict[environment]['taxon']:
            ...
            diversity_cov_taxon_all.extend([mean_diversity_cov_predicted, mean_richness_observed])
    ...
    for distance_idx, distance in enumerate(distances):
        ...
        ax_richness_cov_phylo.scatter(mean_richness_observed, mean_richness_cov_predicted, color=color_taxon, s=40, linewidth=0.8, edgecolors='k', zorder=2)
        ax_diversity_cov_phylo.scatter(mean_diversity_observed, mean_diversity_cov_predicted, color=color_taxon, s=40, linewidth=0.8, edgecolors='k', zorder=2)
...
ax_richness_cov_phylo.plot([richness_cov_phylo_min*0.8,richness_cov_phylo_max*1.2],[richness_cov_phylo_min*0.8,richness_cov_phylo_max*1.2], lw=2,ls='--',c='k',zorder=2, label='1:1')
...
ax_diversity_cov_phylo.plot([diversity_cov_phylo_min*0.8,diversity_cov_phylo_max*1.2],[diversity_cov_phylo_min*0.8,diversity_cov_phylo_max*1.2], lw=2,ls='--',c='k',zorder=2, label='1:1')
...
fig_name = "%svar_summary.png" % (config.analysis_directory)
