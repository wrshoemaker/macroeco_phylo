...
fig_name = "%sfigure-2-figure-supplement-13-fine_vs_coarse_variance_ratio_phylo%s.png" % (config.analysis_directory, diversity_utils.get_rarefied_label(rarefied))
