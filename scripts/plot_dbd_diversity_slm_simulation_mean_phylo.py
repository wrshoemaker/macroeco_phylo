...
for environment_idx, environment in enumerate(diversity_utils.environments_to_keep):
    ...
    for distance_idx, distance in enumerate(distances):
        ...
        ax.scatter(mean_slope, mean_slope_slm, color=color_phylo, s=40, linewidth=0.8, edgecolors='k', zorder=2)
...
#sax_taxon.plot([taxon_min,taxon_max], [taxon_min,taxon_max], lw=2,ls='--',c='k',zorder=1, label='1:1')
...
ax.set_title("Phylogenetic coarse-graining", fontsize=12, fontweight='bold')
...
fig_name = "%sdbd_diversity_slm_simulation_mean_phylo.png" % (config.analysis_directory)
