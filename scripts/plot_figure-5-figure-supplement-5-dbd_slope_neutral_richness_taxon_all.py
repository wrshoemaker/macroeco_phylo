...
for environment_idx, environment in enumerate(environments_to_keep):
    ...
    for coarse_rank_idx, coarse_rank in enumerate(diversity_utils.taxa_ranks[1:]):
        ...
        if coarse_rank in taxa_ranks:
            ...
            predicted = dbd_dict[environment]['taxon'][coarse_rank]['slope_neutral_all']
...
fig_name = "%sfigure-5-figure-supplement-5-dbd_slope_neutral_richness_taxon_all.png" % (config.analysis_directory)
