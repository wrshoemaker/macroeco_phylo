...
dbd_dict = dbd_utils.load_diversity_slm_dbd_simulation_taxon_dict()
...
fig_name = "%sfigure-6-figure-supplement-1-dbd_slope_slm_simulation_diversity_taxon_all.png" % (config.analysis_directory)
